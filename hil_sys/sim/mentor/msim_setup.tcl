...
# ----------------------------------------
# If hil_sys is one of several IP cores in your
...
# ----------------------------------------
# ACDS 23.2 94 linux 2023.08.17.05:22:05
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "hil_sys.hil_sys"
}
...
set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [hil_sys::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
if {[dict size $LD_LIBRARY_PATH] !=0 } {
  set LD_LIBRARY_PATH [subst [join [dict keys $LD_LIBRARY_PATH] ":"]]
  setenv LD_LIBRARY_PATH "$LD_LIBRARY_PATH"
}
append ELAB_OPTIONS [subst [hil_sys::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [hil_sys::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [hil_sys::get_memory_files "$QSYS_SIMDIR"]]
  ...
  set normalized_src [hil_sys::normalize_path "$file"]
  set normalized_dest [hil_sys::normalize_path "$dest_file"]
...
set design_libraries [dict merge $design_libraries [hil_sys::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [hil_sys::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [hil_sys::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
